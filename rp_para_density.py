...
rhol_range = [5.0e2, 1.4e4]                     # density range
n_runs = 10                                            # number of runs
title='Density Parametric Study'     #title
...
# --- Bubble solution ---
def bubble_solution(rhol):
    y0 = [R0, Rdot0]
    sol = solve_ivp(sys, t_span, y0, args=(rhol,), method='Radau', max_step=1e-8)
